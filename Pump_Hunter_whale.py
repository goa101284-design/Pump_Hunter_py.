...
# =====================================================================
# 🛠 ВСПOМОГАТЕЛЬНЫЕ ФУНКЦИИ ДЛЯ РАЗБОРА СВЕЧЕЙ (DICT или LIST)
# =====================================================================
def parse_kline(kline):
    """Универсальный парсер свечи: считывает и словарь, и список"""
...
async def scan_market():
    ...
    async with aiohttp.ClientSession() as session:
        await send_telegram_message("🤖 **Сканер перезапущен без ошибок KeyError!**")
